...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Volo.Abp.Identity.IdentityUser", b =>
                {
                    ...
                    b.Property<int?>("ProfileIsOk")
                        .ValueGeneratedOnUpdateSometimes()
                        .HasColumnType("int")
                        .HasColumnName("ProfileIsOk");
            ...
            modelBuilder.Entity("WorldTravel.Entities.Blogs.Blog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex(new[] { "ImageId" }, "IX_AppBlogs_FileId");

                    b.ToTable("AppBlogs");
                });

            modelBuilder.Entity("WorldTravel.Entities.Categories.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WorldTravel.Entities.Forms.Form", b =>
                {
                    ...
                    b.Property<int>("FormIsOk")
                        .HasColumnType("int");

                    b.Property<string>("FormRegType")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("IsBecomeConsultDesc")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.Property<string>("IsNeedConsult")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.HasIndex(new[] { "UserId" }, "IX_AppCountryContent_UserId");
            ...
            modelBuilder.Entity("WorldTravel.Entities.Jobs.Job", b =>
                {
                    ...
                    b.Property<string>("AccommodationFee")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("WorldTravel.Entities.Receipts.Receipt", b =>
                {
                    ...
                    b.HasIndex(new[] { "FileId" }, "IX_AppReceipt_FileId");

                    b.HasIndex(new[] { "UserId" }, "IX_AppReceipt_UserId");

                    b.ToTable("AppReceipts");
                });
            ...
            modelBuilder.Entity("WorldTravel.Entities.Sliders.Slider", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex(new[] { "ImageId" }, "IX_AppSlider_FileId");
            ...
            modelBuilder.Entity("WorldTravel.Entities.Forms.Form", b =>
                {
                    b.HasOne("WorldTravel.Entities.Users.AppUser", null)
                        .WithMany("Forms")
            ...
            modelBuilder.Entity("WorldTravel.Entities.Receipts.Receipt", b =>
                {
                    ...
                    b.HasOne("WorldTravel.Entities.Users.AppUser", "User")
                        .WithMany("ReceiptList")
                        .HasForeignKey("UserId")
